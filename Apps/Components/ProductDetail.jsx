...
export default function ProductDetail() {
    ...
    const checkIfFavorite = async () => {
        try {
            ...
            // Update header buttons after checking favorite status
            setupHeaderButtons();
        } catch (error) {
    ...
    const toggleFavorite = async () => {
        ...
        try {
            ...
            // Update header buttons after toggling favorite
            setupHeaderButtons();
        } catch (error) {
    ...
    const toggleCompare = async () => {
        ...
        try {
            ...
            if (isInCompareList) {
                ...
                // Check how many items are already in the compare list
                const compareRef = firestore.collection('CompareList')
                    .where('userEmail', '==', user.primaryEmailAddress.emailAddress);
    ...
    const setPriceAlert = async () => {
        ...
        try {
            ...
            if (hasPriceAlert) {
                // Show current alert and option to delete
